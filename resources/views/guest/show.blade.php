            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h3 class="text-sm font-semibold text-gray-600 uppercase mb-2">Start Time</h3>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h3 class="text-sm font-semibold text-gray-600 uppercase mb-2">End Time</h3>
                ...
                @if(isset($event->googleEvent) && $event->googleEvent->getAttendees())
                    <div class="mb-6">
                        <h3 class="text-sm font-semibold text-gray-600 uppercase mb-2">Attendees</h3>
                        <div class="bg-gray-50 p-4 rounded-lg">
                ...
                @if(isset($event->googleEvent) && $event->googleEvent->getHangoutLink())
                    <div class="mb-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <a href="{{ $event->googleEvent->getHangoutLink() }}" target="_blank" class="text-blue-600 hover:underline">Join video call</a>
                        </div>
                    </div>
                @endif
                ...
                <div class="mt-8">
                    <form action="{{ route('guest.join', $event->id) }}" method="POST" class="max-w-md mx-auto">
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-500 mt-2 text-sm">Enter your email to join this event. No sign-in required.</p>
                        </div>
                    </form>
                </div>
            </div>
